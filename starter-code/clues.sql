...
-- so find the least populated country in Southern Europe, and we'll start looking for her there.
	...
	SELECT name,population FROM country WHERE continent = 'Europe' ORDER BY population;
...
-- headed to, but doesn't end the same. Find out the city, and do another search for what country it's in. Hurry!
	...
	SELECT countrycode FROM city WHERE name LIKE '%Serr%';
	SELECT name FROM city WHERE countrycode = 'BRA' AND name LIKE 'serr%';
	Serra, Brazil
